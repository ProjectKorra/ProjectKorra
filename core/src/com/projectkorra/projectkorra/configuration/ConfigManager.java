...
public class ConfigManager {
	...
	public static void configCheck(final ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Commands.Preset.NoSuchPreset", "There is no preset with that name.");
			config.addDefault("Commands.Preset.Created", "Created a new preset named '{name}'.");
			config.addDefault("Commands.Preset.Delete", "You have deleted your preset '{name}'.");
			config.addDefault("Commands.Preset.SuccessfullyBound", "Bound '{name}' preset.");
			...
			config.addDefault("Commands.Preset.BoundForOthers", "The bound slots of {target} have been set to match the {name} preset.");
			config.addDefault("Commands.Preset.FailedToBindAllOthers", "Some abilities were not bound because the player cannot bend the required element.");
			config.addDefault("Commands.Preset.UnableToBind", "Unable to bind preset.");
