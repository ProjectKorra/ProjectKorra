...
public class BlockSource {
	 ...
	 * 
	 * @param player
	 *            the player performing the bending.
	 * @param clickType
	 ...
	 *            a player.
	 * @param block
	 *            the block that is considered a source.
	 * @param sourceType
	 *            the elemental type of the block.
	 * @param clickType
	 *            the type of click, either SHIFT_DOWN or LEFT_CLICK.
	 */
	 ...
	 * 
	 * @param player
	 *            the player that is trying to bend.
	 * @param clickType
	 ...
	 *            the player that is trying to bend.
	 * @param range
	 *            the maximum range to access the block.
	 * @param sourceType
	 *            the elemental type of block to find.
	 * @param clickType
	 *            the action that was performed to access the source, either
	 *            ClickType.SHIFT_DOWN or ClickType.LEFT_CLICK.
	 * @return a valid bendable block, or null if none was found.
	 ...
	 *            the maximum range to access the block.
	 * @param allowWater
	 *            true if water blocks are allowed.
	 * @param allowIce
	 *            true if ice blocks are allowed.
	 * @param allowPlant
	 *            true if plant blocks are allowed.
	 * @return a valid Water bendable block, or null if none was found.
	 */
	 ...
	 *            the action that was performed to access the source, either
	 *            ClickType.SHIFT_DOWN or ClickType.LEFT_CLICK.
	 * @param allowNearbySubstitute
	 *            if a valid earth source could not be found then this method
	 *            will attempt to find a nearby valid earth block.
	 * @return a valid Earth bendable block, or null if none was found.
	 */
