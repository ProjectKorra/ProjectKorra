...
public class LavaFlow {	
	...
	private long clickLavaDelay, clickLandDelay, clickLavaCooldown, clickLandCooldown, shiftCooldown;
	...
	/**
	 * Creates a new LavaFlow ability and initializes all of the variables
	 * and cooldowns. The ability is not guaranteed to continue, it may be the case
	 * that the player doesn't have the correct permissions to bend this ability.
	 ...
	 * This is the heart of the ability, it determines whether or not the
	 * LavaFlow type is Click/Sneaking, and it will remove the ability if any
	 * issues arise.
	 */
	 ...
	 * It also appends the TempBlock to our arraylist called TEMP_LAVA_BLOCKS.
	 * 
	 * If ALLOW_NATURAL_FLOW is turned on then this method
	 * will remove the block from TempBlock.instances,
	 * which will allow the lava to flow naturally.
	 ...
	 * any blocks that are remaining in TEMP_LAVA_BLOCKS,
	 * and cancels any remaining tasks.
	 * 
	 * This version of remove will create tasks that remove each
	 * lava block with an animation.
	 */
	public void remove() {
	 ...
	 * This method does not cause any block animation,
	...
	/**
	 * Removes every instancce of LavaFlow without
	 * animating the block removing process.
	 */
