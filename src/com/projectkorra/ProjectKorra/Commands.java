			...
			public boolean onCommand(CommandSender s, Command c, String label, String[] args) {
				...
				if (Arrays.asList(helpaliases).contains(args[0])) {
					...
					if (args.length != 2) {
						...
						if (s.hasPermission("bending.command.add")) s.sendMessage(ChatColor.YELLOW + "/bending add <Player> [Element]");
						if (s.hasPermission("bending.command.bind")) s.sendMessage(ChatColor.YELLOW + "/bending bind [Ability] <Slot>");
						if (s.hasPermission("bending.command.clear")) s.sendMessage(ChatColor.YELLOW + "/bending clear <slot>");
						if (s.hasPermission("bending.command.choose")) s.sendMessage(ChatColor.YELLOW + "/bending choose <Player> [Element]");
						if (s.hasPermission("bending.command.display")) s.sendMessage(ChatColor.YELLOW + "/bending display <Element>");
						if (s.hasPermission("bending.command.import")) s.sendMessage(ChatColor.YELLOW + "/bending import");
						if (s.hasPermission("bending.admin.permaremove")) s.sendMessage(ChatColor.YELLOW + "/bending permaremove <Player>");
						if (s.hasPermission("bending.admin.remove")) s.sendMessage(ChatColor.YELLOW + "/bending remove [Player]");
						if (s.hasPermission("bending.command.toggle")) s.sendMessage(ChatColor.YELLOW + "/bending toggle");
						if (s.hasPermission("bending.command.version")) s.sendMessage(ChatColor.YELLOW + "/bending version");
						if (s.hasPermission("bending.command.who")) s.sendMessage(ChatColor.YELLOW + "/bending who");
						if (s.hasPermission("bending.command.give")) s.sendMessage(ChatColor.YELLOW + "/bending give [Player] [Item] <Properties>");
						if (s.hasPermission("bending.command.invincible")) s.sendMessage(ChatColor.YELLOW + "/bending invincible");
						return true;
					}
