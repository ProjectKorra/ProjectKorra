...
public class AirSuction {
	...
	public AirSuction(Player player) {
		...
		if (AirSpout.getPlayers().contains(player) || WaterSpout.getPlayers().contains(player)) return;
		this.player = player;
	...
	public static void setOrigin(Player player) {
		...
		if (GeneralMethods.isRegionProtectedFromBuild(player, "AirSuction", location)) return;
	...
	private void advanceLocation() {
		AirMethods.playAirbendingParticles(location, 7);
