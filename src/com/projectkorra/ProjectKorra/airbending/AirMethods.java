...
public class AirMethods {
	...
	public static ParticleEffect getAirbendingParticles() {
		...
		if (particle == null) return ParticleEffect.CLOUD;
		else if (particle.equalsIgnoreCase("spell")) return ParticleEffect.SPELL;
		else if (particle.equalsIgnoreCase("blacksmoke")) return ParticleEffect.SMOKE;
		else if (particle.equalsIgnoreCase("smoke")) return ParticleEffect.CLOUD;
		else return ParticleEffect.CLOUD;
	}
	 ...
	 *            The player to check
	 * @param first
	 *            If the move is being activated
	 * @param hovering
	 *            If the player is using the move to hover
