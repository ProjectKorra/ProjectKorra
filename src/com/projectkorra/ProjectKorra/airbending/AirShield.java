...
public class AirShield {
	...
	public AirShield(Player player) {
		if (AvatarState.isAvatarState(player) && instances.containsKey(player.getEntityId()) && isToggle) {
	...
	private void rotateShield() {
		...
		for (Entity entity : GeneralMethods.getEntitiesAroundPoint(origin, radius)) {
			if (GeneralMethods.isRegionProtectedFromBuild(player, "AirShield", entity.getLocation())) continue;
