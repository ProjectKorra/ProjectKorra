    ...
    public void animate() {
        ...
        for (LivingEntity lent : targets) {
            ...
            if (dt < t1) {
                ...
                new SuffocateSpiral(target, steps, radius - Math.min(radius * 3 / 4, (radius * 3.0 / 4 * ((double) (dt - t3) / (double) (t4 - t3)))), delay, 0,
                        0, 0, SpiralType.HORIZONTAL1);
                new SuffocateSpiral(target, steps, radius - Math.min(radius * 3 / 4, (radius * 3.0 / 4 * ((double) (dt - t3) / (double) (t4 - t3)))), delay, 0,
                        0, 0, SpiralType.VERTICAL1);
                new SuffocateSpiral(target, steps, radius - Math.min(radius * 3 / 4, (radius * 3.0 / 4 * ((double) (dt - t3) / (double) (t4 - t3)))), delay, 0,
                        0, 0, SpiralType.VERTICAL2);
            }
            else {
