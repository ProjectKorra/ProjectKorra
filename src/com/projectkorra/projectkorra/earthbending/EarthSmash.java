...
public class EarthSmash extends EarthAbility {
	...
	public EarthSmash(Player player, ClickType type) {
		...
		this.requiredBendableBlocks = ConfigManager.earthConfig.get().getInt("Abilities.Earth.EarthSmash.RequiredBendableBlocks");
		this.maxBlocksToPassThrough = ConfigManager.earthConfig.get().getInt("Abilities.Earth.EarthSmash.MaxBlocksToPassThrough");
		this.shootAnimationInterval = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.ShootAnimationInterval");
		this.flightAnimationInterval = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.FlightAnimationInterval");
		this.liftAnimationInterval = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.LiftAnimationInterval");
		this.grabDetectionRadius = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.GrabDetectionRadius");
		this.flightDetectionRadius = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.FlightDetectionRadius");
		this.allowGrab = ConfigManager.earthConfig.get().getBoolean("Abilities.Earth.EarthSmash.AllowGrab");
		this.allowFlight = ConfigManager.earthConfig.get().getBoolean("Abilities.Earth.EarthSmash.AllowFlight");
		this.selectRange = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.SelectRange");
		this.grabRange = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.GrabRange");
		this.shootRange = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.ShootRange");
		this.damage = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.Damage");
		this.knockback = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.Knockback");
		this.knockup = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.Knockup");
		this.flightSpeed = ConfigManager.earthConfig.get().getDouble("Abilities.Earth.EarthSmash.FlightSpeed");
		this.chargeTime = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.ChargeTime");
		this.cooldown = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.Cooldown");
		this.flightRemoveTimer = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.FlightTimer");
		this.removeTimer = ConfigManager.earthConfig.get().getLong("Abilities.Earth.EarthSmash.RemoveTimer");
		...
		if (type == ClickType.SHIFT_DOWN || type == ClickType.SHIFT_UP && !player.isSneaking()) {
			if (bPlayer.isAvatarState()) {
				this.selectRange = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.Earth.EarthSmash.SelectRange");
				this.grabRange = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.Earth.EarthSmash.GrabRange");
				this.chargeTime = ConfigManager.avatarConfig.get().getLong("Abilities.Avatar.AvatarState.Earth.EarthSmash.ChargeTime");
				this.cooldown = ConfigManager.avatarConfig.get().getLong("Abilities.Avatar.AvatarState.Earth.EarthSmash.Cooldown");
				this.damage = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.Earth.EarthSmash.Damage");
				this.knockback = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.Earth.EarthSmash.Knockback");
				this.flightSpeed = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.Earth.EarthSmash.FlightSpeed");
				this.flightRemoveTimer = ConfigManager.avatarConfig.get().getLong("Abilities.Avatar.AvatarState.Earth.EarthSmash.FlightTimer");
				this.shootRange = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.Earth.EarthSmash.ShootRange");
			}
