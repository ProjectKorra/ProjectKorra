...
public class LavaWall {
	...
	public boolean prepare() {
		cancelPrevious();
		Block block = BlockSource.getEarthOrLavaSourceBlock(player, selectRange, selectRange, ClickType.LEFT_CLICK, dynamic, false, true, EarthMethods.canSandbend(player));
		if (block != null) {
			sourceblock = block;
			focusBlock();
			return true;
