...
public class Torrent extends WaterAbility {
	...
	public Torrent(Player player) {
		...
		this.layer = 0;
		this.startAngle = 0;
		this.maxLayer = ConfigManager.waterConfig.get().getInt("Abilities.Water.Torrent.MaxLayer");
		this.push = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.Push");
		this.angle = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.Angle");
		this.radius = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.Radius");
		this.maxUpwardForce = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.MaxUpwardForce");
		this.interval = ConfigManager.waterConfig.get().getLong("Abilities.Water.Torrent.Interval");
		this.damage = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.InitialDamage");
		this.successiveDamage = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.SuccessiveDamage");
		this.maxHits = ConfigManager.waterConfig.get().getInt("Abilities.Water.Torrent.MaxHits");
		this.deflectDamage = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.DeflectDamage");
		this.range = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.Range");
		this.selectRange = ConfigManager.waterConfig.get().getDouble("Abilities.Water.Torrent.SelectRange");
		this.cooldown = ConfigManager.waterConfig.get().getLong("Abilities.Water.Torrent.Cooldown");
		this.revert = ConfigManager.waterConfig.get().getBoolean("Abilities.Water.Torrent.Revert");
		this.revertTime = ConfigManager.waterConfig.get().getLong("Abilities.Water.Torrent.RevertTime");
