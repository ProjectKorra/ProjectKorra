...
public class OctopusForm extends WaterAbility {
	...
	public OctopusForm(Player player) {
		...
		this.range = ConfigManager.waterConfig.get().getInt("Abilities.Water.OctopusForm.Range");
		this.damage = ConfigManager.waterConfig.get().getInt("Abilities.Water.OctopusForm.Damage");
		this.interval = ConfigManager.waterConfig.get().getLong("Abilities.Water.OctopusForm.FormDelay");
		this.attackRange = ConfigManager.waterConfig.get().getInt("Abilities.Water.OctopusForm.AttackRange");
		this.knockback = ConfigManager.waterConfig.get().getDouble("Abilities.Water.OctopusForm.Knockback");
		this.radius = ConfigManager.waterConfig.get().getDouble("Abilities.Water.OctopusForm.Radius");
		this.cooldown = ConfigManager.waterConfig.get().getLong("Abilities.Water.OctopusForm.Cooldown");
		this.angleIncrement = ConfigManager.waterConfig.get().getDouble("Abilities.Water.OctopusForm.AngleIncrement");
