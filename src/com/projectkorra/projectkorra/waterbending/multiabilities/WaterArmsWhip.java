...
public class WaterArmsWhip extends WaterAbility {
	...
	public WaterArmsWhip(Player player, Whip ability) {
		...
		this.grappled = false;
		this.grabbed = false;
		this.grappleRespectRegions = ConfigManager.waterConfig.get().getBoolean("Abilities.Water.WaterArms.Whip.Grapple.RespectRegions");
		...
		this.whipLength = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.MaxLength");
		this.whipLengthWeak = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.MaxLengthWeak");
		this.whipLengthNight = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.NightAugments.MaxLength.Normal");
		this.whipLengthFullMoon = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.NightAugments.MaxLength.FullMoon");
		this.initLength = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Arms.InitialLength");
		this.punchLength = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.Punch.MaxLength");
		this.punchLengthNight = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.Punch.NightAugments.MaxLength.Normal");
		this.punchLengthFullMoon = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Whip.Punch.NightAugments.MaxLength.FullMoon");
		this.activeLength = initLength;
		this.whipSpeed = 2;
		this.holdTime = ConfigManager.waterConfig.get().getLong("Abilities.Water.WaterArms.Whip.Grab.HoldTime");
		this.usageCooldown = ConfigManager.waterConfig.get().getLong("Abilities.Water.WaterArms.Arms.Cooldowns.UsageCooldown");
		this.pullMultiplier = ConfigManager.waterConfig.get().getDouble("Abilities.Water.WaterArms.Whip.Pull.Multiplier");
		this.punchDamage = ConfigManager.waterConfig.get().getDouble("Abilities.Water.WaterArms.Whip.Punch.PunchDamage");
