...
public class WaterArms extends WaterAbility {
	...
	public WaterArms(Player player) {
		...
		this.canUsePlantSource = ConfigManager.waterConfig.get().getBoolean("Abilities.Water.WaterArms.Arms.AllowPlantSource");
		this.lightningEnabled = ConfigManager.waterConfig.get().getBoolean("Abilities.Water.WaterArms.Arms.Lightning.Enabled");
		this.lightningKill = ConfigManager.waterConfig.get().getBoolean("Abilities.Water.WaterArms.Arms.Lightning.KillUser");
		this.initLength = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Arms.InitialLength");
		this.sourceGrabRange = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Arms.SourceGrabRange");
		this.maxPunches = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Arms.MaxAttacks");
		this.maxIceBlasts = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Arms.MaxIceShots");
		this.maxUses = ConfigManager.waterConfig.get().getInt("Abilities.Water.WaterArms.Arms.MaxAlternateUsage");
		this.cooldown = ConfigManager.waterConfig.get().getLong("Abilities.Water.WaterArms.Arms.Cooldown");
		this.lightningDamage = ConfigManager.waterConfig.get().getDouble("Abilities.Water.WaterArms.Arms.Lightning.Damage");
