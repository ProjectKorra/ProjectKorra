...
public class ConfigManager {
	...
	public static void configCheck(ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Abilities.Fire.Blaze.Instructions", "Tap sneak to send a combustion out in the direction you're looking. It will expload on impact, or you can left click to manually expload it. This deals damage to players who are in radius of the blast.");
			...
			config.addDefault("Abilities.Chi.AcrobatStance.Description", "AcrobatStance gives a Chiblocker a higher probability of blocking a Bender's Chi while granting them a Speed and Jump Boost. It also increases the rate at which the hunger bar depletes. Acrobatstance is incredibly useful for chasing after opponents who are running away.");
			config.addDefault("Abilities.Chi.AcrobatStance.Instructions", "Left click to activate the AcrobatStance mode. Additionally, left click again to disable the AcrobatStance move.");
			config.addDefault("Abilities.Chi.HighJump.Description", "HighJump is a chiblocker technique that is extremely useful for dodging abilities or confusing your opponent.");
			config.addDefault("Abilities.Chi.HighJump.Instructions", "Left click to perform a high jump. You must be on the ground to do so.");
			config.addDefault("Abilities.Chi.Paralyze.Description", "Paralyze is an advanced chiblocking technique. The ability allows you to hit certain pressure points to leave your target paralyzed and unable to move. This ability can be used for great damage when combined with other abilities, such as RapidPunch.");
			config.addDefault("Abilities.Chi.Paralyze.Instructions", "Left click on a player to paralyze them.");
			...
			config.addDefault("Abilities.Chi.Smokescreen.Description", "Smokescreen, if used correctly, can serve as a defensive and offensive ability for Chiblockers. Smokescreen fires out a smoke bomb that exploads when it hits the ground and give all players within a small radius of the explosion temporary blindness, allowing you to either get away, or move in for the kill.");
			config.addDefault("Abilities.Chi.Smokescreen.Instructions", "Left click in a direction to fire a smoke bomb that will expload on impact.");
