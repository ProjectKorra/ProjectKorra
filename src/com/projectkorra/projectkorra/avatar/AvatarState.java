...
public class AvatarState extends AvatarAbility {
	...
	public AvatarState(Player player) {
		...
		this.regenEnabled = ConfigManager.avatarConfig.get().getBoolean("Abilities.Avatar.AvatarState.PotionEffects.Regeneration.Enabled");
		this.speedEnabled = ConfigManager.avatarConfig.get().getBoolean("Abilities.Avatar.AvatarState.PotionEffects.Speed.Enabled");
		this.resistanceEnabled = ConfigManager.avatarConfig.get().getBoolean("Abilities.Avatar.AvatarState.PotionEffects.DamageResistance.Enabled");
		this.fireResistanceEnabled = ConfigManager.avatarConfig.get().getBoolean("Abilities.Avatar.AvatarState.PotionEffects.FireResistance.Enabled");
		this.regenPower = ConfigManager.avatarConfig.get().getInt("Abilities.Avatar.AvatarState.PotionEffects.Regeneration.Power") - 1;
		this.speedPower = ConfigManager.avatarConfig.get().getInt("Abilities.Avatar.AvatarState.PotionEffects.Speed.Power") - 1;
		this.resistancePower = ConfigManager.avatarConfig.get().getInt("Abilities.Avatar.AvatarState.PotionEffects.DamageResistance.Power") - 1;
		this.fireResistancePower = ConfigManager.avatarConfig.get().getInt("Abilities.Avatar.AvatarState.PotionEffects.FireResistance.Power") - 1;
		this.duration = ConfigManager.avatarConfig.get().getLong("Abilities.Avatar.AvatarState.Duration");
		this.cooldown = ConfigManager.avatarConfig.get().getLong("Abilities.Avatar.AvatarState.Cooldown");	
		this.factor = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.PowerMultiplier");
	...
	public static double getValue(double value) {
		double factor = ConfigManager.avatarConfig.get().getDouble("Abilities.Avatar.AvatarState.PowerMultiplier");
		return factor * value;
	}
